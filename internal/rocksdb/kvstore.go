...
func NewRocksDB(db *grocksdb.DB, nodeID string, snapshotter *snap.Snapshotter, proposeC chan<- string, commitC <-chan *kvstore.Commit, errorC <-chan error) *RocksDB {
...
func (s *RocksDB) readCommits(commitC <-chan *kvstore.Commit, errorC <-chan error) {
