...
func createTestPebble(t *testing.T) (*pebble.DB, string, func()) {
	t.Helper()

	tmpDir, err := os.MkdirTemp("", "pebble-mvcc-test-*")
	if err != nil {
...
func TestPebbleStorePutGet(t *testing.T) {
	db, _, cleanup := createTestPebble(t)
	defer cleanup()

	store, err := NewPebbleStore(db)
	if err != nil {
...
func TestPebbleStorePutUpdate(t *testing.T) {
	db, _, cleanup := createTestPebble(t)
	defer cleanup()
...
func TestPebbleStoreGetHistorical(t *testing.T) {
	db, _, cleanup := createTestPebble(t)
	defer cleanup()
...
func TestPebbleStoreDeleteRange(t *testing.T) {
	db, _, cleanup := createTestPebble(t)
	defer cleanup()
...
func TestPebbleStoreCompact(t *testing.T) {
	db, _, cleanup := createTestPebble(t)
	defer cleanup()
...
func TestPebbleStoreCompactErrors(t *testing.T) {
	db, _, cleanup := createTestPebble(t)
	defer cleanup()
...
func TestPebbleStoreTxnSimple(t *testing.T) {
	db, _, cleanup := createTestPebble(t)
	defer cleanup()
...
func TestPebbleStoreTxnConditionFailed(t *testing.T) {
	db, _, cleanup := createTestPebble(t)
	defer cleanup()
...
func TestPebbleStoreTxnGet(t *testing.T) {
	db, _, cleanup := createTestPebble(t)
	defer cleanup()
...
func TestPebbleStoreTxnDelete(t *testing.T) {
	db, _, cleanup := createTestPebble(t)
	defer cleanup()
...
func TestPebbleStoreEmptyKey(t *testing.T) {
	db, _, cleanup := createTestPebble(t)
	defer cleanup()
...
func TestPebbleStoreLease(t *testing.T) {
	db, _, cleanup := createTestPebble(t)
	defer cleanup()
...
func TestPebbleStoreCurrentRevision(t *testing.T) {
	db, _, cleanup := createTestPebble(t)
	defer cleanup()
...
func TestPebbleStoreCompactedRevision(t *testing.T) {
	db, _, cleanup := createTestPebble(t)
	defer cleanup()
...
func TestPebbleStorePersistence(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "pebble-mvcc-persist-*")
	if err != nil {
		t.Fatalf("Failed to create temp dir: %v", err)
	}
...
func TestPebbleStoreDBSize(t *testing.T) {
	db, _, cleanup := createTestPebble(t)
	defer cleanup()
...
func TestPebbleStoreHash(t *testing.T) {
	db, _, cleanup := createTestPebble(t)
	defer cleanup()
...
func TestPebbleStoreSync(t *testing.T) {
	db, _, cleanup := createTestPebble(t)
	defer cleanup()
...
func TestPebbleStoreKeyEncoding(t *testing.T) {
	db, _, cleanup := createTestPebble(t)
	defer cleanup()
