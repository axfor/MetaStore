...
type RaftOperation struct {
	...
	GrantTime int64 `protobuf:"varint,11,opt,name=grant_time,json=grantTime,proto3" json:"grant_time,omitempty"` // unix nano, preserves original GrantTime across WAL replay
...
func (x *RaftOperation) GetGrantTime() int64 {
	if x != nil {
		return x.GrantTime
	}
	return 0
...
const file_internal_proto_raft_proto_rawDesc = "" +
	...
	"\n" +
	"grant_time\x18\v \x01(\x03R\tgrantTime\x12+\n" +
