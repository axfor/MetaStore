...
// NewMemory creates a new memory-backed KV store
func NewMemory(snapshotter *snap.Snapshotter, proposeC chan<- string, commitC <-chan *Commit, errorC <-chan error) *Memory {
...
func (s *Memory) readCommits(commitC <-chan *Commit, errorC <-chan error) {
