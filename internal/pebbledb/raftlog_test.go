...
func TestPebbleStorage_BasicOperations(t *testing.T) {
	...
	// Create storage
	storage, err := NewPebbleStorage(db, "test_node")
	require.NoError(t, err)
	defer storage.Close()
...
func TestPebbleStorage_AppendEntries(t *testing.T) {
	tmpDir := "test-pebble-append"
	defer os.RemoveAll(tmpDir)
...
func TestPebbleStorage_Term(t *testing.T) {
	tmpDir := "test-pebble-term"
	defer os.RemoveAll(tmpDir)
...
func TestPebbleStorage_HardState(t *testing.T) {
	tmpDir := "test-pebble-hardstate"
	defer os.RemoveAll(tmpDir)
...
func TestPebbleStorage_Snapshot(t *testing.T) {
	tmpDir := "test-pebble-snapshot"
	defer os.RemoveAll(tmpDir)
...
func TestPebbleStorage_ApplySnapshot(t *testing.T) {
	tmpDir := "test-pebble-apply-snapshot"
	defer os.RemoveAll(tmpDir)
...
func TestPebbleStorage_Persistence(t *testing.T) {
	tmpDir := "test-pebble-persistence"
	defer os.RemoveAll(tmpDir)
