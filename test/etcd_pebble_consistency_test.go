...
// TestEtcdPebbleClusterDataConsistencyAfterWrites tests data consistency after writes
func TestEtcdPebbleClusterDataConsistencyAfterWrites(t *testing.T) {
	const numNodes = 3
...
// TestEtcdPebbleClusterSequentialWrites tests sequential writes to cluster
func TestEtcdPebbleClusterSequentialWrites(t *testing.T) {
	const numNodes = 3
	clus := newEtcdPebbleCluster(t, numNodes)
	defer clus.Close(t)
...
// TestEtcdPebbleClusterRangeQueryConsistency tests range query consistency
func TestEtcdPebbleClusterRangeQueryConsistency(t *testing.T) {
	const numNodes = 3
	clus := newEtcdPebbleCluster(t, numNodes)
	defer clus.Close(t)
...
// TestEtcdPebbleClusterDeleteConsistency tests delete operation consistency
func TestEtcdPebbleClusterDeleteConsistency(t *testing.T) {
	const numNodes = 3
	clus := newEtcdPebbleCluster(t, numNodes)
	defer clus.Close(t)
...
// TestEtcdPebbleClusterConcurrentMixedOperations tests mixed concurrent operations
func TestEtcdPebbleClusterConcurrentMixedOperations(t *testing.T) {
	const numNodes = 3
	clus := newEtcdPebbleCluster(t, numNodes)
	defer clus.Close(t)
...
// TestEtcdPebbleClusterRevisionConsistency tests revision consistency across nodes
func TestEtcdPebbleClusterRevisionConsistency(t *testing.T) {
	const numNodes = 3
	clus := newEtcdPebbleCluster(t, numNodes)
	defer clus.Close(t)
...
// TestEtcdPebbleClusterTransactionConsistency tests transaction consistency across cluster
func TestEtcdPebbleClusterTransactionConsistency(t *testing.T) {
	const numNodes = 3
	clus := newEtcdPebbleCluster(t, numNodes)
	defer clus.Close(t)
