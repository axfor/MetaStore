...
| **存储层** | Memory/Pebble | 0.1-0.5 ms | 5-15% | ⭐⭐⭐ 中 |
...
│ Layer 4: 存储层 (Memory/Pebble) → +2-3x    │
...
- 修改文件: `internal/pebble/kvstore.go`
...
Pebble MixedWorkload: 4,921.00 ops/sec
```
...
**Day 2**: 集成到 Memory 和 Pebble 引擎
```bash
# 修改文件
vim cmd/metastore/main.go
vim internal/memory/kvstore.go
vim internal/pebble/kvstore.go
```
...
| **Pebble QPS** | 4,921 | 25,000 | 60,000 | 120,000 | **24x** |
